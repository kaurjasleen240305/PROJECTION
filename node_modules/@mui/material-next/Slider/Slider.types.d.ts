...
export type SliderValueLabelProps = NonNullable<SliderTypeMap['props']['slotProps']>['valueLabel'] & Pick<SliderTypeMap['props'], 'valueLabelFormat' | 'valueLabelDisplay' | 'value' | 'disabled'> & {
    /**
