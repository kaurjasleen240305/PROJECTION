...
export type FormControlProps<RootComponentType extends React.ElementType = FormControlTypeMap['defaultComponent'], AdditionalProps = {}> = OverrideProps<FormControlTypeMap<AdditionalProps, RootComponentType>, RootComponentType> & {
    component?: React.ElementType;
};
type MaterialDesignOwnerStateKeys = 'classes' | 'color' | 'margin' | 'size' | 'fullWidth' | 'hiddenLabel' | 'variant';
export type FormControlOwnerState = Simplify<Required<Pick<FormControlOwnProps, MaterialDesignOwnerStateKeys>> & FormControlProps>;
export {};
