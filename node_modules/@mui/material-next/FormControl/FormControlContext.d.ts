...
type ContextFromPropsKey = 'color' | 'disabled' | 'error' | 'fullWidth' | 'hiddenLabel' | 'margin' | 'required' | 'size' | 'variant';
 ...
 * @internal
 */
declare const FormControlContext: React.Context<FormControlContextValue | undefined>;
