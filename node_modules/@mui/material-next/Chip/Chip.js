...
import { unstable_capitalize as capitalize, unstable_useForkRef as useForkRef, unstable_unsupportedProp as unsupportedProp } from '@mui/utils';
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, disabled && 'disabled', `size${capitalize(size)}`, color && `color${capitalize(color)}`, clickable && 'clickable', hasDeleteIcon && 'deletable'],
    label: ['label'],
    avatar: ['avatar'],
    icon: ['icon'],
...
const ChipRoot = styled('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    }, styles.root, styles[`size${capitalize(size)}`], color && styles[`color${capitalize(color)}`], clickable && styles.clickable, hasDeleteIcon && styles.deletable, styles[variant]];
  }
})(({
  theme,
  ownerState
  ...
  const labelTextColor = {
    filled: tokens.sys.color[`on${capitalize((_ownerState$color2 = ownerState.color) != null ? _ownerState$color2 : 'secondary')}Container`],
    outlined: tokens.sys.color.onSurface,
    elevated: tokens.sys.color[ownerState.color ? `on${capitalize(ownerState.color)}Container` : 'onSurface']
  };
  ...
  return _extends({
    ...
    [`& .${chipClasses.avatar}`]: _extends({
      width: 24,
      height: 24,
      marginLeft: 4,
      color: tokens.sys.color[`on${capitalize((_ownerState$color4 = ownerState.color) != null ? _ownerState$color4 : 'secondary')}`],
...
const Chip = /*#__PURE__*/React.forwardRef(function Chip(inProps, ref) {
  ...
  if (onDelete) {
    ...
    deleteIcon = deleteIconProp && /*#__PURE__*/React.isValidElement(deleteIconProp) ? /*#__PURE__*/React.cloneElement(deleteIconProp, {
      className: clsx((_deleteIconProp$props = deleteIconProp.props) == null ? void 0 : _deleteIconProp$props.className, classes.deleteIcon),
  ...
  if (hasAvatar) {
    ...
    avatar = /*#__PURE__*/React.cloneElement(avatarProp, {
      className: clsx(classes.avatar, (_avatarProp$props = avatarProp.props) == null ? void 0 : _avatarProp$props.className)
    });
  }
  let icon = null;
  if (hasIcon) {
    ...
    icon = /*#__PURE__*/React.cloneElement(iconProp, {
      className: clsx(classes.icon, (_iconProp$props = iconProp.props) == null ? void 0 : _iconProp$props.className)
    });
  }
  ...
  const rootProps = useSlotProps({
    ...
    getSlotProps: otherHandlers => _extends({}, otherHandlers, {
  ...
  return /*#__PURE__*/_jsxs(ChipRoot, _extends({}, rootProps, {
...
process.env.NODE_ENV !== "production" ? Chip.propTypes /* remove-proptypes */ = {
   ...
   */
  color: PropTypes /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes.oneOf(['primary', 'secondary', 'tertiary', 'error', 'info', 'success', 'warning']), PropTypes.string]),
  /**
   ...
   * @default 'filled'
   */
  variant: PropTypes /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes.oneOf(['filled', 'outlined', 'elevated']), PropTypes.string])
} : void 0;
export default Chip;