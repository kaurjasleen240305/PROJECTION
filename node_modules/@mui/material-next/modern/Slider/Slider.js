...
const _excluded = ["aria-label", "aria-valuetext", "aria-labelledby", "component", "color", "classes", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "size", "step", "scale", "slotProps", "slots", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat"];
...
export const SliderRoot = styled('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`color${capitalize(ownerState.color || 'primary')}`], ownerState.size !== 'medium' && styles[`size${capitalize(ownerState.size)}`], ownerState.marked && styles.marked, ownerState.orientation === 'vertical' && styles.vertical, ownerState.track === 'inverted' && styles.trackInverted, ownerState.track === false && styles.trackFalse];
  }
})(({
  theme,
  ownerState
...
export const SliderThumb = styled('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.thumb, props.isOverlapping && styles.thumbOverlap, styles[`thumbColor${capitalize(ownerState.color || 'primary')}`], ownerState.size !== 'medium' && styles[`thumbSize${capitalize(ownerState.size)}`]];
  }
})(({
  theme,
  ownerState
...
export const SliderValueLabel = styled('span', {
  name: 'MuiSlider',
  slot: 'ValueLabel',
  shouldForwardProp: prop => shouldForwardProp(prop) && prop !== 'isOverlapping' && prop !== 'valueLabelDisplay' && prop !== 'valueLabelFormat',
  overridesResolver: (props, styles) => [styles.valueLabel, props.isOverlapping && styles.valueLabelOverlap]
})(({
  theme,
  ownerState
}) => {
  ...
  const letterSpacing = `${theme.sys.typescale.label.medium.tracking / theme.sys.typescale.label.medium.size}rem`;
  const labelStyle = {
    color: ownerState.disabled ? tokens.sys.color.surface : tokens.sys.color[`on${capitalize(ownerState.color || 'primary')}`],
  ...
  return _extends({
    ...
    [`& .${sliderClasses.valueLabelLabel}`]: _extends({
...
const Slider = /*#__PURE__*/React.forwardRef(function Slider(inProps, ref) {
  ...
  const propsWithDefaultValues = _extends({}, props, {
    isRtl,
    max,
    min,
    classes: classesProp,
  ...
  const {
    ...
    trackOffset,
    trackLeap
  } = useSlider(_extends({}, propsWithDefaultValues, {
    rootRef: ref
  }));
  const ownerState = _extends({}, propsWithDefaultValues, {
  ...
  const lastActiveThumbIndexRef = React.useRef(-1);
  ...
  return /*#__PURE__*/_jsxs(RootSlot, _extends({}, rootProps, {
    children: [/*#__PURE__*/_jsx(RailSlot, _extends({}, railProps)), /*#__PURE__*/_jsx(TrackSlot, _extends({}, trackProps)), marks.filter(mark => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      const style = axisProps[axis].offset(percent);
      const isThumbOverlapping = overlapApi.getIsThumbOverlapping(index, lastActiveThumbIndexRef.current);
      const isValueLabelOverlapping = valueLabelDisplay === 'on' && overlapApi.getIsValueLabelOverlapping(index, lastActiveThumbIndexRef.current);
      return /*#__PURE__*/_jsxs(ThumbSlot, _extends({
        "data-index": index
      }, thumbProps, {
        className: clsx(classes.thumb, thumbProps.className, active === index && classes.active, focusedThumbIndex === index && classes.focusVisible, isThumbOverlapping && classes.thumbOverlap),
      ...
      }, !isHostComponent(ThumbSlot) && {
        isOverlapping: isThumbOverlapping
      }, {
        children: [/*#__PURE__*/_jsx(InputSlot, _extends({
          ...
          value: values[index]
        }, inputSliderProps)), valueLabelDisplay !== 'off' ? /*#__PURE__*/_jsx(ValueLabelSlot, _extends({}, !isHostComponent(ValueLabelSlot) && {
          valueLabelFormat,
          valueLabelDisplay,
          ...
          className: clsx(valueLabelProps.className, (open === index || active === index || valueLabelDisplay === 'on') && classes.valueLabelOpen, isValueLabelOverlapping && classes.valueLabelOverlap),
          ref: valueLabelRef => {
            valueLabelProps.ref?.(valueLabelRef);
            overlapApi.setValueLabelRef(index, valueLabelRef);
          },
          children: /*#__PURE__*/_jsx("span", {
            className: classes.valueLabelLabel,
