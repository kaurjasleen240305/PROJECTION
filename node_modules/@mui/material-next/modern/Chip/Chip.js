...
const ChipRoot = styled('div', {
  ...
  const containerColor = {
    filled: tokens.sys.color[`${ownerState.color ?? 'secondary'}Container`],
    outlined: 'transparent',
    elevated: tokens.sys.color[ownerState.color ? `${ownerState.color}Container` : 'surfaceContainerLow']
  };
  const labelTextColor = {
    filled: tokens.sys.color[`on${capitalize(ownerState.color ?? 'secondary')}Container`],
  ...
  return _extends({
    ...
    [`& .${chipClasses.avatar}`]: _extends({
      ...
      height: 24,
      marginLeft: 4,
      color: tokens.sys.color[`on${capitalize(ownerState.color ?? 'secondary')}`],
