...
export default function extendTheme(options = {}, ...args) {
  ...
  const shape = _extends({}, (_input$sys = input.sys) == null ? void 0 : _input$sys.shape, md3shape, {
    corner: _extends({}, (_input$sys2 = input.sys) == null || (_input$sys2 = _input$sys2.shape) == null ? void 0 : _input$sys2.corner, md3shape.corner)
  });
  ...
  const _createThemeWithoutVa = createThemeWithoutVars(_extends({}, input, {
      ...
      ref: _extends({}, input.ref, {
        typeface,
        palette: deepmerge(md3CommonPalette, (_colorSchemesInput$li = colorSchemesInput.light) == null || (_colorSchemesInput$li = _colorSchemesInput$li.ref) == null ? void 0 : _colorSchemesInput$li.palette)
      }),
      sys: _extends({}, input.sys, {
        typescale,
        state,
        motion,
        color: _extends({}, md3LightColors, (_colorSchemesInput$li2 = colorSchemesInput.light) == null || (_colorSchemesInput$li2 = _colorSchemesInput$li2.sys) == null ? void 0 : _colorSchemesInput$li2.color),
        elevation: (_colorSchemesInput$li3 = (_colorSchemesInput$li4 = colorSchemesInput.light) == null || (_colorSchemesInput$li4 = _colorSchemesInput$li4.sys) == null ? void 0 : _colorSchemesInput$li4.elevation) != null ? _colorSchemesInput$li3 : elevationLight,
        shape
      }),
      palette: _extends({}, colorSchemesInput.light && ((_colorSchemesInput$li5 = colorSchemesInput.light) == null ? void 0 : _colorSchemesInput$li5.palette))
    })),
    {
  ...
  const {
    ...
    ref: _extends({}, input.ref, {
      typeface,
      palette: deepmerge(md3CommonPalette, (_colorSchemesInput$da2 = colorSchemesInput.dark) == null || (_colorSchemesInput$da2 = _colorSchemesInput$da2.ref) == null ? void 0 : _colorSchemesInput$da2.palette)
    }),
    sys: _extends({}, input.sys, {
      typescale,
      state,
      motion,
      color: _extends({}, md3DarkColors, (_colorSchemesInput$da3 = colorSchemesInput.dark) == null || (_colorSchemesInput$da3 = _colorSchemesInput$da3.sys) == null ? void 0 : _colorSchemesInput$da3.color),
      elevation: (_colorSchemesInput$da4 = (_colorSchemesInput$da5 = colorSchemesInput.dark) == null || (_colorSchemesInput$da5 = _colorSchemesInput$da5.sys) == null ? void 0 : _colorSchemesInput$da5.elevation) != null ? _colorSchemesInput$da4 : elevationDark,
      shape
    })
  });
  const {
