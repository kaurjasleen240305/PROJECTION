...
const overridesResolver = (props, styles) => {
  ...
  return [styles.root, styles[`position${(0, _composeClasses.unstable_capitalize)(ownerState.position)}`], ownerState.disablePointerEvents === true && styles.disablePointerEvents, styles[ownerState.variant]];
};
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disablePointerEvents && 'disablePointerEvents', position && `position${(0, _composeClasses.unstable_capitalize)(position)}`, variant, hiddenLabel && 'hiddenLabel', size && `size${(0, _composeClasses.unstable_capitalize)(size)}`]
  };
