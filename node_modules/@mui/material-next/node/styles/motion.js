...
function createMotions(inputMotion = {}) {
  const mergedEasing = (0, _extends2.default)({}, easing, inputMotion.easing);
  const mergedDuration = (0, _extends2.default)({}, duration, inputMotion.duration);
