...
var _TabsListContext = _interopRequireDefault(require("../Tabs/TabsListContext"));
var _jsxRuntime = require("react/jsx-runtime");
const _excluded = ["className", "disableFocusRipple", "fullWidth", "icon", "iconPosition", "indicator", "label", "textColor", "value", "wrapped"]; // TODO: use useButton hook here
...
const Tab = /*#__PURE__*/React.forwardRef(function Tab(inProps, ref) {
  ...
  const tabsListContext = React.useContext(_TabsListContext.default);
  if (tabsListContext != null) {
    var _indicator, _textColor, _fullWidth;
    (_indicator = indicator) != null ? _indicator : indicator = tabsListContext.indicator;
    (_textColor = textColor) != null ? _textColor : textColor = tabsListContext.textColor;
    (_fullWidth = fullWidth) != null ? _fullWidth : fullWidth = tabsListContext.fullWidth;
  }
