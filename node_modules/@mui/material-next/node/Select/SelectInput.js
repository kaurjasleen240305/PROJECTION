...
var _NativeSelectInput = require("@mui/material/NativeSelect/NativeSelectInput");
var _Menu = _interopRequireDefault(require("@mui/material/Menu/Menu"));
var _utils2 = require("../InputBase/utils");
var _styled = _interopRequireDefault(require("../styles/styled"));
var _selectClasses = _interopRequireWildcard(require("./selectClasses"));
var _jsxRuntime = require("react/jsx-runtime");
var _span;
const _excluded = ["aria-describedby", "aria-label", "autoFocus", "autoWidth", "children", "className", "defaultOpen", "defaultValue", "disabled", "displayEmpty", "error", "IconComponent", "inputRef", "labelId", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "SelectDisplayProps", "tabIndex", "type", "value", "variant"]; // TODO v6: replace with material-next Menu component when available https://github.com/mui/material-ui/pull/38934
...
const SelectIcon = (0, _styled.default)('svg', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.icon, ownerState.variant && styles[`icon${(0, _utils.unstable_capitalize)(ownerState.variant)}`], ownerState.open && styles.iconOpen];
  }
})(_NativeSelectInput.nativeSelectIconStyles);
const SelectNativeInput = (0, _styled.default)('input', {
  shouldForwardProp: prop => (0, _system.shouldForwardProp)(prop) && prop !== 'classes',
  name: 'MuiSelect',
  slot: 'NativeInput',
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    icon: ['icon', `icon${(0, _utils.unstable_capitalize)(variant)}`, open && 'iconOpen', disabled && 'disabled'],
...
const SelectInput = /*#__PURE__*/React.forwardRef(function SelectInput(props, ref) {
  ...
  const handleRef = (0, _utils.unstable_useForkRef)(ref, inputRefProp);
  ...
  React.useEffect(() => {
    ...
    const label = (0, _utils.unstable_ownerDocument)(displayRef.current).getElementById(labelId);
    if (label) {
      const handler = () => {
