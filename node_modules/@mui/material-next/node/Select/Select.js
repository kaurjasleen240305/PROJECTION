...
var _NativeSelectInput = _interopRequireDefault(require("@mui/material/NativeSelect/NativeSelectInput"));
...
const _excluded = ["autoWidth", "children", "classes", "className", "defaultOpen", "displayEmpty", "IconComponent", "id", "input", "inputProps", "label", "labelId", "MenuProps", "multiple", "native", "onClose", "onOpen", "open", "renderValue", "SelectDisplayProps", "variant"],
  _excluded2 = ["root"]; // TODO v6: Remove Input component after implementing Material You design
...
const Select = /*#__PURE__*/React.forwardRef(function Select(inProps, ref) {
  ...
  const inputComponentRef = (0, _utils.unstable_useForkRef)(ref, InputComponent.ref);
