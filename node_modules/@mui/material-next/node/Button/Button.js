...
var _buttonBaseClasses = _interopRequireDefault(require("../ButtonBase/buttonBaseClasses"));
var _ButtonBase = _interopRequireDefault(require("../ButtonBase"));
var _jsxRuntime = require("react/jsx-runtime");
const _excluded = ["children", "classes", "color", "disableElevation", "endIcon", "fullWidth", "size", "startIcon", "variant"];
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, `color${(0, _utils.unstable_capitalize)(color != null ? color : '')}`, `size${(0, _utils.unstable_capitalize)(size != null ? size : '')}`, disableElevation && 'disableElevation', fullWidth && 'fullWidth'],
    label: ['label'],
...
const ButtonRoot = exports.ButtonRoot = (0, _styles.styled)(_ButtonBase.default, {
  name: 'MuiButton',
  slot: 'Root',
  shouldForwardProp: prop => (0, _system.shouldForwardProp)(prop),
  ...
  return (0, _extends2.default)({
    ...
    [`&.${_buttonBaseClasses.default.active}`]: (0, _extends2.default)({
    ...
    [`&.${_buttonBaseClasses.default.focusVisible}`]: {
    ...
    [`&.${_buttonBaseClasses.default.disabled}`]: (0, _extends2.default)({
