...
const _excluded = ["children", "classes", "color", "component", "disabled", "error", "focused", "fullWidth", "hiddenLabel", "margin", "required", "size", "slotProps", "slots", "variant"];
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', margin !== 'none' && `margin${(0, _utils.unstable_capitalize)(margin)}`, fullWidth && 'fullWidth']
  };
...
const FormControlRoot = (0, _styled.default)('div', {
  ...
  overridesResolver: ({
    ...
    return [styles.root, styles[`margin${(0, _utils.unstable_capitalize)(ownerState.margin)}`], ownerState.fullWidth && styles.fullWidth];
  }
})(({
  ownerState
}) => (0, _extends2.default)({
 ...
 */
const FormControl = /*#__PURE__*/React.forwardRef(function FormControl(inProps, forwardedRef) {
  var _slots$root;
  ...
  const [adornedStart, setAdornedStart] = React.useState(() => {
    ...
    if (children) {
      React.Children.forEach(children, child => {
        if (!(0, _utils.unstable_isMuiElement)(child, ['Input', 'Select'])) {
          return;
        }
        const input = /*#__PURE__*/React.isValidElement(child) && (0, _utils.unstable_isMuiElement)(child, ['Select']) ? child.props.input : child;
  ...
  const [filled, setFilled] = React.useState(() => {
    ...
    if (children) {
      React.Children.forEach(children, child => {
        ...
        if ( /*#__PURE__*/React.isValidElement(child) && ((0, _utils2.isFilled)(child.props, true) || (0, _utils2.isFilled)(child.props.inputProps, true))) {
          initialFilled = true;
        }
      });
    }
  ...
  const Root = (_slots$root = slots.root) != null ? _slots$root : FormControlRoot;
