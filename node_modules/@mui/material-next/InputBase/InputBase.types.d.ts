...
export interface InputBaseTypeMap<AdditionalProps = {}, RootComponentType extends React.ElementType = 'div'> {
    props: InputBaseOwnProps & AdditionalProps;
    defaultComponent: RootComponentType;
}
export type InputBaseProps<RootComponentType extends React.ElementType = InputBaseTypeMap['defaultComponent'], AdditionalProps = {}> = OverrideProps<InputBaseTypeMap<AdditionalProps, RootComponentType>, RootComponentType> & {
    inputComponent?: React.ElementType;
};
export type InputBaseOwnerState = Simplify<InputBaseOwnProps & {
    formControl: FormControlContextValue | undefined;
    hiddenLabel?: boolean;
    focused: boolean;
    type: React.InputHTMLAttributes<HTMLInputElement>['type'] | undefined;
}>;
export type InputBaseRootSlotProps = Simplify<UseInputRootSlotProps & {
    ownerState: InputBaseOwnerState;
    className?: string;
    children?: React.ReactNode;
    ref?: React.Ref<HTMLDivElement>;
}>;
export type InputBaseInputSlotProps = Simplify<Omit<UseInputRootSlotProps, 'onClick'> & {
